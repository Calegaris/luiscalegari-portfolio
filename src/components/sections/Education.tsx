      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {education.map((item, idx) => (
          <motion.div
            ...
            className="relative rounded-2xl p-6 lg:p-8 bg-slate-900/60 border border-slate-800/90 hover:border-sky-500/30 backdrop-blur-md transition-all duration-300 space-y-6"
          >
            {/* Header / Institution */}
